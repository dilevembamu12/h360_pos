...
use App\Http\Controllers\QuickMenuController; //custom
...
Route::middleware(['setData'])->group(function () {
    ...
    Route::get('/pay-mobilemoney/{token}', [SellPosController::class, 'invoicePaymentByMobileMoney'])
        ->name('invoice_payment_by_mobilemoney');
    /************** */
    ...
    /* custom code 101 */
    Route::post('/trigger-payment/{id}', [SellPosController::class, 'triggerPayment'])
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/business/reset-rewards', [BusinessController::class, 'resetRewards'])->name('business.resetRewards');//customcode 14122024
    ...
    Route::get('/products/sku_scanner', [ProductController::class, 'skuScan']);
    ...
    /*** personnalize custom code 06022024-MULTIDEVISE001***/
    //Route::get('/invoice-schemes/set_default/{id}', [InvoiceSchemeController::class, 'setDefault']);
    Route::resource('secondary-currency', InvoiceSchemeController::class);
    /******* endcustomcode ******/
    ...
    /********custom */
    Route::get('/quickmenu', [QuickMenuController::class, 'index'])->name('quickmenu'); //custom
    Route::get('/reports/manuel-report-cash', [AccountController::class, 'index2'])->name('manuel-report-cash'); //custom

    Route::get('/reports/manuel-report', [ReportController::class, 'getManuelreport']); //custom
    Route::get('/reports/manuel-report2', [ReportController::class, 'getManuelreport2']); //custom
    Route::get('/reports/manuel-report3', [ReportController::class, 'getManuelreport3']); //custom
    /***************** */
});
