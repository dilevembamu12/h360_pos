                        ...
                        @foreach($payrolls as $employee => $payroll)
                            @php
                                if ($action != 'edit') {
                                    ...
                                    elseif ($payroll['essentials_pay_period'] == 'hour') {
                                        $total_work_duration = Carbon::parse($transaction_date)->daysInMonth*24;
                                        $duration_unit = __('lang_v1.hour');
                                    }
                                    /***end custom_code**/
                            ...
                            <tr data-id="{{$employee}}">
                                ...
                                <td>
                                    ...
                                    {{-- personnalize custom code 18092024-001 gestion de HEURE unité de salire --}}
                                    <br><br>
                                    <span style="color: red" class="hour_precision">
                                        
                                    <b>**{{__('essentials::lang.work_duration')}} Personnalisée :</b> 
                                    {{
                                        __('essentials::lang.work_duration_hour', ['duration' =>

                                            str_replace(session('currency')['decimal_separator'],'.', str_replace(session('currency')['thousand_separator'],"",$payroll['total_work_duration']) )
                                            *60/str_replace(session('currency')['decimal_separator'],'.', str_replace(session('currency')['thousand_separator'],"",session('business')['hour_precision']) ) 
