    ...
    <div class="col-md-4">
        <div class="form-group">
            <div class="multi-input">
                ...
                {!! Form::select('essentials_pay_period', ['month' => __('essentials::lang.per'). ' '.__('lang_v1.month'), 'week' => __('essentials::lang.per'). ' '.__('essentials::lang.week'), 'day' => __('essentials::lang.per'). ' '.__('lang_v1.day') /*personnalize custom code 18092024-001 gestion de HEURE unité de salire*/, 'hour' => __('essentials::lang.per'). ' '.__('lang_v1.hour')/***end custom_code**/], !empty($user->essentials_pay_period) ? $user->essentials_pay_period : null, ['class' => 'form-control width-60 pull-left']); !!}
