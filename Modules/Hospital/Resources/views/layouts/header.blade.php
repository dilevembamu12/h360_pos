{{-- Modules/Hospital/Resources/views/layouts/header.blade.php --}}
{{-- En-tête spécifique au module Hôpital --}}


@inject('request', 'Illuminate\Http\Request')
<!-- Main Header -->
<header class="main-header no-print">
    <a href="{{action([\Modules\Hospital\Http\Controllers\DashboardController::class, 'index'])}}" class="logo">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{action([\Modules\Hospital\Http\Controllers\ManageProfileController::class, 'getProfile'])}}" class="btn btn-default btn-flat">
