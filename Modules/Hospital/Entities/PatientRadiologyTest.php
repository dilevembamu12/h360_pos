...
class PatientRadiologyTest extends Model
{
     ...
     * @var string
     */
    protected $table = 'hospital_patient_radiology_tests';
    ...
    /**
     * Get the type of radiology test.
     */
    ...
    */
     ...
     /**
     * Get the files associated with this radiology test (using polymorphic relation).
     * Allows attaching multiple files (like image files, scan of report, etc.)
     */
    ...
    // Factory trait
    // use \Modules\Hospital\Database\Factories\PatientRadiologyTestFactory;
    // protected static function newFactory()
    // {
    //     return PatientRadiologyTestFactory::new();
    // }
}