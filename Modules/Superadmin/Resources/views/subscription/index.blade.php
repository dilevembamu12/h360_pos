...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <strong><span style="color:red">Note : il est strictement interdit de payer votre abonnement au près d’un commercial ou tout autre agent de H360.
H360 ne sera pas tenu responsable du retard ou de toute autre complication d’un paiement d’abonnement fait en dehors des méthodes de paiement autorisées (MPESA, ORANGE MONEY, AIRTEL MONEY, AFRICELL MONEY, CARTE VISA, MASTERCARD).
</span></strong><br><br>
