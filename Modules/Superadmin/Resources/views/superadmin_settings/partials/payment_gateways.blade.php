<div class="pos-tab-content">
        ...
        <div class="col-xs-6">
            <div class="form-group">
                ...
                {!! Form::textarea(
                    ...
                    !empty($settings['offline_payment_details']) ? $settings['offline_payment_details'] : null,
                    ['class' => 'form-control', 'placeholder' => __('superadmin::lang.offline_payment_details'), 'rows' => 3],
                ) !!}
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <h4>Paymbongo: <small>(MPESA , ORANGE, AIRTEL, AFRICELL MONEY , FLEXPAY partner)</small></h4>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('FLEXPAY_MERCHANT', 'Code Marchant:') !!}
                {!! Form::text('FLEXPAY_MERCHANT', $default_values['FLEXPAY_MERCHANT'] ?? '', [
                    'class' => 'form-control',
                    'id' => 'flexpay_merchant',
                ]) !!}
            </div>
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group">
                {!! Form::label('FLEXPAY_TOKEN', 'Token:') !!}
                {!! Form::text('FLEXPAY_TOKEN', $default_values['FLEXPAY_TOKEN'] ?? '', [
                    'class' => 'form-control',
                    'id' => 'flexpay_token',
                ]) !!}
            </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                {!! Form::text('STRIPE_PUB_KEY', $default_values['STRIPE_PUB_KEY'], [
                    'class' => 'form-control',
                    'placeholder' => __('superadmin::lang.stripe_pub_key'),
                ]) !!}
            </div>
        </div>
        <div class="col-xs-4">
            <div class="form-group">
                ...
                {!! Form::text('STRIPE_SECRET_KEY', $default_values['STRIPE_SECRET_KEY'], [
                    'class' => 'form-control',
                    'placeholder' => __('superadmin::lang.stripe_secret_key'),
                ]) !!}
            </div>
        </div>
        ...
        <div class="col-xs-6">
            <div class="form-group">
                ...
                {!! Form::select('PAYPAL_MODE', ['live' => 'Live', 'sandbox' => 'Sandbox'], $default_values['PAYPAL_MODE'], [
                    'class' => 'form-control',
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                {!! Form::text('PAYPAL_CLIENT_ID', $default_values['PAYPAL_CLIENT_ID'], [
                    'class' => 'form-control',
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                {!! Form::text('PAYPAL_APP_SECRET', $default_values['PAYPAL_APP_SECRET'], [
                    'class' => 'form-control',
        ...
        <div class="col-xs-4">
            ...
            1. @lang('superadmin::lang.login_to') <a href="https://developer.paypal.com/home" target="_blank">@lang('superadmin::lang.developer_account')
            </a>.<br />
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                {!! Form::text('PESAPAL_CONSUMER_SECRET', $default_values['PESAPAL_CONSUMER_SECRET'], [
                    'class' => 'form-control',
                ]) !!}
            </div>
        </div>
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                {!! Form::select('PESAPAL_LIVE', ['false' => 'False', 'true' => 'True'], $default_values['PESAPAL_LIVE'], [
                    'class' => 'form-control',
                ]) !!}
            </div>
        </div>
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                {!! Form::text('FLUTTERWAVE_ENCRYPTION_KEY', $default_values['FLUTTERWAVE_ENCRYPTION_KEY'], [
                    'class' => 'form-control',
                ]) !!}
            </div>
        </div>
