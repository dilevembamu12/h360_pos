...
Route::middleware('web', 'auth', 'language', 'AdminSidebarMenu', 'superadmin')->prefix('superadmin')->group(function () {
    /********* custom_code 17062024 ******/
            //pour rendre le menu superadmin avec des sous menu
            Route::get('/sms', [Modules\Superadmin\Http\Controllers\SMSController::class, 'index']);
            /************************************************** */
...
Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->group(function () {
    ...
    Route::match(['get', 'post'],'/subscription/flexpay-callback', [Modules\Superadmin\Http\Controllers\SubscriptionController::class, 'confirm_flexpaySubscription'])->name('confirmFlexpaySubscription');
    Route::match(['get', 'post'],'/subscription/{package_id}/flexpay-trigger', [Modules\Superadmin\Http\Controllers\SubscriptionController::class, 'trigger_flexpay'])->name('triggerFlexpaySubscription');
    /**************************************************** */
