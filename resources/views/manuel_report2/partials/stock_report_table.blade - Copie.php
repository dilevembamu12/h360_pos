    ...
    @component('components.widget', ['title' => $key, 'class' => 'box-primary', 'id' => $key])
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <h1>Resumé en stock vendu (en {{ $my_unit }}).</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <h1>Resumé en prix de vente (Dollars ($)).</h1>
    ...
    <div class="col-md-12">
        ...
        @component('components.widget', ['title' => 'Tous les rapports'])
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <h1>Rapport général en stock vendu (en {{ $my_unit }}).</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <h1>Rapport général en prix de vente (Dollars ($)).</h1>
