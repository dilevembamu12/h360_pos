...
@php
    ...
    foreach ($currencies as $key => $value) {
        ...
        //$currencies[$key] = str_replace('(', "($value", $_currencies[$currency_id]);/pas important ici , car on doit recuperer le sybole de la devise
    }
@endphp
{{--  **************************************************** --}}
...
@php
    //dd($currency_details);
    //$_currency_id=$_GET['currency'];
    $_currency_id = $currency_details->id;
    /*
    ...
    //dd($currencies);
    //dd($currencies['currency_'.$_GET['currency']]);
    //j'applique le taux de convertion
    foreach ($variations as $key => $value) {
        ...
        */
        /*
        $val=$value->sell_price_inc_tax*$rate;
        $value->default_purchase_price = 5000;

        $value->dpp_inc_tax = 5000;
        $value->default_sell_price = 5000;
        $value->sell_price_inc_tax = 5000;
        */
        
        //$variations[$key]->sell_price_inc_tax =5000;
        
        /*
        $variations[$key]->default_purchase_price *= $rate;
        $variations[$key]->dpp_inc_tax *= $rate;
        $variations[$key]->default_sell_price *= $rate;
        $variations[$key]->sell_price_inc_tax *= $rate;
        */
        /*
        $variations[$key]->default_purchase_price = $variations[$key]->default_purchase_price* $rate;
        $variations[$key]->dpp_inc_tax =$variations[$key]->dpp_inc_tax* $rate;
        $variations[$key]->default_sell_price =$variations[$key]->default_sell_price* $rate;
        $variations[$key]->sell_price_inc_tax =number_format($variations[$key]->sell_price_inc_tax,12)*$rate;
        */
    }
    //dd($variations);
@endphp
