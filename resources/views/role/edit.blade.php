        ...
        @component('components.widget', ['class' => 'box-primary'])
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox(
                                            'tba_permissions[]',
                                            'account.tba.' . $account->id,
                                            in_array('account.tba.' . $account->id, $role_permissions),
                                            ['class' => 'input-icheck'],
                                        ) !!} {{ $account->name }}
                                    </label>
                                </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    ...
                    {{-- custom : specification des categorie --}}
                    @if (count($categories) > 0)
                        <div class="col-md-12">
                            <h4>Visibilité de catégories**</h4>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox(
                                            'permissions[]',
                                            'category.visibility.' . $category->id,
                                            in_array('category.visibility.' . $category->id, $role_permissions),
                                            ['class' => 'input-icheck'],
                                        ) !!} {{ $category->name }}
                                    </label>
                                </div>
            ...
            @if (in_array('expenses', $enabled_modules))
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                            ...
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        in_array('expense_category.view', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!}
                                    Ajouter/Modifier Categorie dépense
                                </label>
                            </div>
                        </div>
                        .
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        'permissions[]',
                                        'view_custom_expense.payments',
                                        in_array('view_custom_expense.payments', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!}
                                    Voir paiement de dépense
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        'permissions[]',
                                        'add_custom_expense.payments',
                                        in_array('add_custom_expense.payments', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!}
                                    Ajouter un paiement de dépense
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        'permissions[]',
                                        'edit_custom_expense.payments',
                                        in_array('edit_custom_expense.payments', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!}
                                    Modifier le paiement de dépense
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        'permissions[]',
                                        'delete_custom_expense.payments',
                                        in_array('delete_custom_expense.payments', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!}
                                    Supprimer le paiement de dépense
                                </label>
                            </div>
                            <hr>
                        </div>
                        ...
                        {{-- custom : specification des categorie de depense --}}
                        @if (count($expense_category) > 0)
                            <div class="col-md-12">
                                <h4>Visibilité de catégories de dépense**</h4>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::checkbox(
                                                'permissions[]',
                                                'expensecategory.visibility.' . $category->id,
                                                in_array('expensecategory.visibility.' . $category->id, $role_permissions),
                                                ['class' => 'input-icheck'],
                                            ) !!} {{ $category->name }}
                                        </label>
                                    </div>
