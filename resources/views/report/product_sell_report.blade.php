                            ...
                            id="product_sell_report_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>**Marge de prix @show_tooltip("Prix modifié - prix normal ")</th>
                                ...
                                <tfoot>
                                    <tr class="bg-gray font-17 footer-total text-center">
                                        <td colspan="{{$colspan}}"><strong>@lang('sale.total'):</strong></td>
                                        ...
                                        <td><span class="display_currency" id="footer_unit_price_diff" data-currency_symbol ="true"></span></td>
                                        
                                        {{-- personnalize custom code 09092024-ADD_PAYMENT_INFO_OF_TRANSACTION  --}}
                                        <td><span class="display_currency" id="footer_total_paid"
                                                data-currency_symbol ="true"></span></td>
                                        <td><span class="display_currency" id="footer_total_no_paid"
                                                data-currency_symbol ="true"></span></td>
                                        {{-- -------------- --}}
                                    </tr>
                                </tfoot>
