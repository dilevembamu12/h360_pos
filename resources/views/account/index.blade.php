                        ...
                        <div class="row">
                            <div class="col-md-12">
                                @component('components.widget')
                                    <div class="col-md-4">
                                        {!! Form::select('account_status', ['active' => __('business.is_active'), 'closed' => __('account.closed'),/**   personnalize custom code 17022025-GESTION DES COMPTE DE PAIEMENT SUPRIMES ***/  'deleted' => __('lang_v1.deleted')/****END***/], null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'account_status']); !!}
                                    </div>
                                    <div class="col-md-8">
