...
@section('javascript')
    <script type="text/javascript">
        /*******custom*************/
        $(document).on('ifChanged', '#show_by_box, #woocommerce_enabled', function() {
        ...
        function load_stock_history(variation_id, location_id) {
            ...
            $.ajax({
                url: '/products/stock-history/' + variation_id + "?location_id=" + location_id+"&product_id={{$product['id']}}"+"&show_by_box="+$('#show_by_box').is(':checked'),//custom,
                dataType: 'html',
