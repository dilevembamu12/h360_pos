    ...
    <section class="content content-custom no-print">
        ...
        @if (auth()->user()->can('dashboard.data'))
            @if ($is_admin)
                ...
                {{------- PERSONNALIZE CUSTOM_CODE 22092024-001 =>AJout des cartes Paiements des ventes et Paiements des achats -------}}
                <div class="row" style="padding: 0 10% 25px 10%">
                    <div class="col-md-12 col-sm-12 col-xs-12 col-custom bg-green" style="border-radius: 25px;padding: 20px;">
                        <strong>** Cher Chef d'Entreprise, les informations ci-dessous, le résumé de vos activités, peuvent ne pas inclure certains aspects comme "la remise", "les cumuls d'achat ou poinst bonus",etc. ainsi nous conseillons vivement de toujours consulter le menu rapport pour obtenir les informations avec exactitude. <br>par CEO Dileve MBAMU </strong>
                    </div>
                </div>
                <div class="row">
                    <!-- /.col -->
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">**Paiements des ventes
                                    @show_tooltip("Total des Ventes (-) Ventes dues (-) paiement des retours de ventes")
                                </span>
                                <span class="info-box-number total_sell_paiement"><i
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">**Paiement des achats
                                    @show_tooltip("Total des Achats (-) achats dues (-) paiement des retours sur les achats")
                                </span>
                                <span class="info-box-number total_purchase_paiement"><i
                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">**Frais des dépenses
                                    @show_tooltip("Total des dépenses directes")
                                </span>
                                <span class="info-box-number total_expense_on_expense"><i
                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                        <div class="info-box info-box-new-style">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">**Frais des salaires
                                    @show_tooltip("Total des dépenses sur les salaires")
                                </span>
                                <span class="info-box-number total_expense_on_payroll"><i
                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        ...
                        <div class="info-box info-box-new-style">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">
                                    Total {{ __('lang_v1.expense') }} 
                                    @show_tooltip("Total des frais sur les dépenses (+) Total des frais sur les salaires")
                                </span>
