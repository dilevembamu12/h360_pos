...
<html lang="en">
    ...
    <body style="border: 1px solid #ccc;padding:0px -10px 0 -10px; !important">
        ...
        @php
        $a=array("Pour une meilleure gestion de votre business: contactez ",
        "Protéger son stock, c'est protéger son argent: commandez le logiciel ", 
...
@page {
    /*margin: 2px; eviter les marge dans les imprimantes thermiques(à eviter car ca fait appairtre les ecrits petis)*/
}
</style>