        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    ...
                    {{--  Trigger le poppup de scannage de barcode --}}
                    <button type="button" class="btn btn-default bg-white btn-flat pos_add_quick_product"
                        data-href="{{ action([\App\Http\Controllers\ProductController::class, 'skuScan']) }}"
                        data-container=".quick_add_product_modal"><i
                            class="fa fa-qrcode text-primary fa-lg"></i></button>
