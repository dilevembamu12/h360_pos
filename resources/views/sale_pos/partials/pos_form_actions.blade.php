...
<div class="row">
    <div class="pos-form-actions">
        <div class="col-md-12">
			...
			{{--  personnalize custom code 24072024-PAY_VIA_MOBILEMONEY -- 24032024 --}}
			{{--  on enleve le bouton de paiement par carten, car on va dorennavent utiliser les carte pour api de flexpay --}}
			{{--
            <button type="button"
            ...
            {{--  personnalize custom code 24072024-PAY_VIA_MOBILEMONEY -- 24032024 --}}
            {{--  Bouton qui permet aux agents de vendre par MOBILE MONEY OU CARTE VISA et AUTRES --}}
			<button type="button"
                class="btn bg-maroon btn-default btn-flat no-print pos-express-finalize"
				id="pos-flexpay"
                data-pay_method="paymbongo_card" title="@lang('lang_v1.tooltip_express_checkout_card')">
                <i class="fas fa-credit-card" aria-hidden="true"></i> **VISA / MASTERCARD/ PREPAYEE
            </button>

			<button type="button"
                class="btn bg-maroon btn-default btn-flat no-print pos-express-finalize"
				id="pos-flexpay"
                data-pay_method="paymbongo_mobilemoney" title="@lang('lang_v1.tooltip_express_checkout_card')">
                <i class="fas fa-credit-card" aria-hidden="true"></i> **MOBILE MONEY
            </button>
            {{-- --------------------- END PERSONNALIZE CUSTOM CODE--------------------------------- --}}
            ...
            <button type="button"
                ...
                id="pos-finalize" title="@lang('lang_v1.tooltip_checkout_multi_pay')"><i class="fas fa-money-check-alt" aria-hidden="true"></i>
                @lang('lang_v1.checkout_multi_pay') </button>
