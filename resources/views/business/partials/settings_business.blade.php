    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <table class="table">
                    {!! Form::label('hour_precision', '**Unité d\'Heure personnalisée'. ':*') !!} @show_tooltip(__('lang_v1.quantity_precision_help'))
                    <tr>
                      <th style="vertical-align: middle;">1H</th>
                      <th style="vertical-align: middle;">=</th>
                      <td style="vertical-align: middle;">
                        {!! Form::text('hour_precision', $business->hour_precision, ['class' => 'form-control input_number', 'placeholder' => __( 'lang_v1.times_base_unit' )]); !!}</td>
