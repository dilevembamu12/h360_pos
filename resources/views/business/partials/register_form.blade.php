<div class="col-md-12" style="border-bottom: 1.5px solid white;">


    <div class="form-group">
        {!! Form::label('affiliate_id', 'Entrez l\'ID de votre Parrain:(laissez vide si vous n\'avez pas de parrain)') !!}
        <div class="input-group">
            <span class="input-group-addon">
                <i class="fas fa-money-bill-alt"></i>
            </span>
            {!! Form::select('affiliate_id', $affiliates, '', [
                'class' => 'form-control select2_register',
                'placeholder' => "Je ne suis pas affilié**",
                '',
            ]) !!}
        </div>
    </div>
...
@if (empty($is_admin))
    <h3>@lang('business.business') (ou Foyer)</h3>
@endif
...
<fieldset>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::select('currency_id', $currencies, env('DRC_CURRENCY_ID'), [
                    'class' => 'form-control select2_register',
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::select('country', $countries, 'CD', [
                    'class' => 'form-control select2_register',
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('zip_code', __('business.zip_code') . ':* (ex: 01034)') !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-map-marker"></i>
                </span>
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('landmark', __('business.landmark') . ':* (ex: address)') !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-map-marker"></i>
                </span>
