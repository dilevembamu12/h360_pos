<div class="pos-tab-content">
    <div class="row">
        ...
        {{--  plus utile car le code du systeme source le gere deja --}}
        {{--
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[block_msp]', 1,  
                        !empty($pos_settings['block_msp']) ? true : false , 
                    [ 'class' => 'input-icheck']); !!} ***Authoriser les ventes superieur au prix minimum
                  </label>
                  @show_tooltip("applicable qu'au cas ou le prix de vente minimum est activé")
                </div>
            </div>
        </div>
        --}}
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::text('pos_settings[flexpay_merchant]', $pos_settings['flexpay_merchant'] ?? '', ['class' => 'form-control', 'id' => 'flexpay_merchant']); !!}
            </div>
        </div>
        <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                {!! Form::text('pos_settings[flexpay_token]', $pos_settings['flexpay_token'] ?? '', ['class' => 'form-control', 'id' => 'flexpay_token']); !!}
            </div>
        </div>
        {{------}}
