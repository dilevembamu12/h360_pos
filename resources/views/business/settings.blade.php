        ...
        <div class="col-xs-12 pos-tab-container">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item text-center">***Devises secondaires</a>
                    {{--  **************************************************** --}}
                    ...
                    {{--/******* personnalize custom code 25072024-HIDE_DEFAULT_SMS_MENU */--}}
                    @if(auth()->user()->business_id!=env('ADMINISTRATOR_BUSINESS'))
                    @else
                    <a href="#" class="list-group-item text-center">@lang('lang_v1.sms_settings')</a>
                    @endif
                    {{--/******* end personnalize custom code 25072024 */--}}
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                ...
                {{--  personnalize custom code 06022024-MULTIDEVISE002 --}}
                @include('business.partials.custom_settings_second_currency')
                {{--  **************************************************** --}}
