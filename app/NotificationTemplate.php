...
class NotificationTemplate extends Model
{
        ...
        return [
            ...
            'payment_paid' => [
                ...
                'extra_tags' => [
                    ...
                    ['{contact_business_name}','{contact_name}', '{contact_business_name}', '{contact_custom_field_1}', '{contact_custom_field_2}', '{contact_custom_field_3}', '{contact_custom_field_4}', '{contact_custom_field_5}', '{contact_custom_field_6}', '{contact_custom_field_7}', '{contact_custom_field_8}', '{contact_custom_field_9}', '{contact_custom_field_10}'],
                ],
            ],
            'items_received' => [
                ...
                'extra_tags' => [
                    ['{business_name}', '{business_logo}'],
                    ['{order_ref_number}'],
                    ['{contact_business_name}', '{contact_business_name}','{contact_name}', '{contact_custom_field_1}', '{contact_custom_field_2}', '{contact_custom_field_3}', '{contact_custom_field_4}', '{contact_custom_field_5}', '{contact_custom_field_6}', '{contact_custom_field_7}', '{contact_custom_field_8}', '{contact_custom_field_9}', '{contact_custom_field_10}'],
                ],
            ],
            'items_pending' => [
    ...
    {
        return ['{contact_business_name}','{contact_name}', '{invoice_number}', '{total_amount}',
    ...
    public static function defaultNotificationTemplates($business_id = null)
    {
        $notification_template_data = [
            [
                ...
                'email_body' => '<p>Cher {contact_name},</p>

                    <p>Votre facture numéro {invoice_number}<br />
                    Montant total: {total_amount}<br />
                    Total payé: {received_amount}</p>
                    ...
                    <p>&nbsp;</p>',
                'sms_body' => 'Cher {contact_name}, Facture N{invoice_number} de {total_amount}$ est disponible.à payer:{due_amount}$ 
                {invoice_url}',
                'subject' => 'ACHAT avec {business_name}',
                'auto_send' => '0',
            ],
