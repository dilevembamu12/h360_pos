...
class AdminSidebarMenu
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        Menu::create('admin-sidebar-menu', function ($menu) {
            ...
            //CUSTOM QuickMenuController
            //QuickMenuController
            $menu->url(action([\App\Http\Controllers\QuickMenuController::class, 'index']), '**Menu rapide', ['icon' => 'fa fas fa fas fa-object-ungroup', 'active' => request()->segment(1) == 'home'])->order(5);
            ...
            if (auth()->user()->can('business_settings.access') ||
                ...
                $menu->dropdown(
                    ...
                    function ($sub) use ($enabled_modules) {
                        ...
                        //je verifie si il a la capacité de modofier , ajouter ou supprimer les devises secondaire
                        /*
