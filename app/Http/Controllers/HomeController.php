...
class HomeController extends Controller
{
    ...
    public function getTotals()
    {
        if (request()->ajax()) {
            ...
            $transaction_types = [
                'purchase_return', 'sell_return', 'expense',/**PERSONNALIZE CUSTOM_CODE 24092024-001 ==>GESTION DES DEPENSES SORTIES VIA LE SALAIRE */ 'payroll',/*****/
            ];
            ...
            /**PERSONNALIZE CUSTOM_CODE 24092024-001 ==>GESTION DES DEPENSES SORTIES VIA LE SALAIRE */ 
            $output['total_payroll']= $transaction_totals['total_payroll'];
            $output['total_expense'] = $transaction_totals['total_expense'];
            $output['total_all_expense'] = $output['total_payroll']+$output['total_expense'];
            /*****/
