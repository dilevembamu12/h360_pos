            ...
            <div class="flex lg:flex-row flex-col gap-8">
                <div class="5xl:w-[54%] lg:w-[74%] w-full">
                    <div class="mt-6 grid 4xl:grid-cols-3 grid-cols-2 gap-4">
                        ...
                        @if(isset ($code['code_model']) && !empty($code['code_model']))
                        <div class="p-4 bg-color-F3 dark:bg-color-47 rounded-lg">
                            <p class="text-color-89 font-Figtree text-sm font-medium">{{ __('Model')}}</p>
                            <p class="text-color-14 dark:text-white text-base font-Figtree font-normal mt-2">{{ $code['code_model'] }}</p>
                        </div>
                        @endif
                        <div class="p-4 bg-color-F3 dark:bg-color-47 rounded-lg">
