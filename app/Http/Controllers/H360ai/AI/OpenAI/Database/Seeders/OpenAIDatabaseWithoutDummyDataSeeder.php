...
use Modules\OpenAI\Database\Seeders\versions\v1_9_0\DatabaseSeeder as DatabaseSeederV19;
use Modules\OpenAI\Database\Seeders\versions\v1_10_0\DatabaseSeeder as DatabaseSeederV10;
...
class OpenAIDatabaseWithoutDummyDataSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->call(DatabaseSeederV19::class);
        $this->call(DatabaseSeederV10::class);
    }
}
