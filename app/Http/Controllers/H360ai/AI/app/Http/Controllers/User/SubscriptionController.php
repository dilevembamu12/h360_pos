...
class SubscriptionController extends Controller
{
    ...
    public function payPendingSubscription(Request $request)
    {
        try {
            ...
            $subscriptionDetails->update(['unique_code' => rand(111111111111, 999999999999)]);
    ...
    public function updateSubscription(Request $request)
    {
        try {
            ...
            $route = GatewayRedirect::paymentRoute(['package_id' => $request->package_id, 'code' => $subscription->code, 'user_id' => $subscription->user_id, 'billing_cycle' => $request->billing_cycle, 'billing_price' => $price], $price, $currency, rand(111111111111, 999999999999), $request, $paymentType);
    ...
    public function storeCredit(Request $request)
    {
        ...
        try {
            ...
            $route = GatewayRedirect::paymentRoute(['package_id' => $request->credit_id, 'code' => 'onetime', 'user_id' => auth()->user()->id], $price, $currency, rand(111111111111, 999999999999), $request, 'single');
