...
class ModuleUtil extends Util
{
    ...
    public function hasThePermissionInSubscription($business_id, $permission, $callback_function = null)
    {
        if ($this->isSuperadminInstalled()) {
            ...
            //{{--  personnalize custom code 27032024-CRM01 -- 27032024}}
            //==>Donnez acces meme aux administrateurs des business d'acceder au crm, au lieu que ca soit seulement le super administrateur
            if($permission=='crm_module'){
                return true;
            }
            /********** end personnalize******** */
